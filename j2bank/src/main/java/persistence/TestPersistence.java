...
public class TestPersistence implements Persistence<Cliente> {

    private static final String PATH = DIRECTORY + File.separator + "testclientes.json";
    ...
    public Cliente buscarCliente(String cpf) {
        Persistence<Cliente> clientes = new TestPersistence();
