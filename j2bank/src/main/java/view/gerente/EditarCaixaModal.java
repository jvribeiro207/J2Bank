 ...
 * @author B r u n o
 */
public class EditarCaixaModal extends javax.swing.JDialog {

    /**
     * Creates new form EditarUsuarioModal
     */
    public EditarCaixaModal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarCaixaModal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarCaixaModal dialog = new EditarCaixaModal(new javax.swing.JFrame(), true);
    ...
    public Caixa getEditar_usuario() {
        return editar_usuario;
    }

    public void setEditar_usuario(Caixa editar_usuario) {
