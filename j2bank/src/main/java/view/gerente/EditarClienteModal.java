 ...
 * @author B r u n o
 */
public class EditarClienteModal extends javax.swing.JDialog {

    /**
     * Creates new form EditarUsuarioModal
     */
    public EditarClienteModal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarClienteModal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarClienteModal dialog = new EditarClienteModal(new javax.swing.JFrame(), true);
    ...
    public Cliente getEditar_usuario() {
        return editar_usuario;
    }

    public void setEditar_usuario(Cliente editar_usuario) {
    ...
    private Cliente editar_usuario;
